  ...
  return (
    <div className="relative bg-[#ffa300] text-white py-20 px-10 flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 w-full text-center">
        ...
        <button className="cursor-pointer bg-transparent text-[#ffa300] border-4 border-[#ffa300] font-semibold py-3 px-6 rounded-full hover:bg-yellow-500 hover:text-black transition">
          ORDER NOW
        </button>
      </div>
