  ...
  return (
    <div className="font-sans text-gray-500 flex items-center justify-center mt-12">
      ...
      <button
        ...
        className="border-3 border-gray-300 md:border-gray-300 cursor-pointer md:bg-gray-100 text-white px-6 py-1 md:py-5 rounded-r hover:bg-[#747575]"
      >
        <img src="/search.svg" alt="Buscador" className="border-white" />
      </button>
    </div>
  );
}
