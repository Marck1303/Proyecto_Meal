    ...
    >
      ...
      <div className="flex flex-wrap justify-center gap-30">
        {miembrosDelGrupo.map((miembro) => (
          <div className="hover:text-red-600 transform hover:scale-105 transition">
            <a
              key={miembro.nombre}
              href={miembro.url}
              target="_blank"
            ...
            >
              <img
                src={miembro.img}
                alt={miembro.nombre}
                className="w-30 h-30 rounded-full mb-2 border-4 border-black shadow hover:border-red-600"
              />
