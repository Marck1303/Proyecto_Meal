...
export default function Card({ id, name, category, image }) {
  ...
  return (
    <div className="bg-white rounded-xl cursor-pointer overflow-hidden hover:scale-105 transition-all duration-300 hover:drop-shadow-[0_0_15px_rgba(400,50,0,0.7)] p-4 border-2 border-amber-600 dark:bg-violet-950 dark:hover:drop-shadow-[0_0_15px_rgba(103,232,249,0.7)] dark:border-purple-700">
